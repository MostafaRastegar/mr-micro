...
var moduleMap = {
	"./Button": () => {
		return Promise.all([__webpack_require__.e("webpack_sharing_consume_default_react_react"), __webpack_require__.e("src_components_Button_jsx-_2fef0")]).then(() => (() => ((__webpack_require__(/*! ./src/components/Button */ "./src/components/Button.jsx")))));
	}
};
